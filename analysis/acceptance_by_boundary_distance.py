...
def main() -> None:
    ...
    out_path = Path(__file__).resolve().parent / "acceptance_by_boundary_distance.json"
    ...
    fig.tight_layout()
    fig.savefig(Path(__file__).resolve().parent / "acceptance_by_boundary_distance.png", facecolor="white")
    plt.close(fig)
